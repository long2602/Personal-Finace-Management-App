...
class _ViewBudgetPageState extends State<ViewBudgetPage> {
  ...
  void initState() {
    super.initState();
    _moneyController.text = textToCurrency(_budget['balance'].toString());
    _nameController.text = _budget['name'];
    _selectedStartDate = (_budget['startDay'] as Timestamp).toDate();
    _selectedEndDate = (_budget['endDay'] as Timestamp).toDate();
  }
              ...
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: MaterialButton(
                    ...
                    elevation: 0,
                    onPressed: () async {
                      num tong = await _userRepository.calculatorRemainBudget(
                        _walletSelected.isEmpty
                            ? _budget['idWallet']
                            : _walletSelected['id'],
                        _selectedStartDate,
                        _selectedEndDate,
                      ...
                      await _userRepository.updateBudget(
                          _budget['id'],
                      ...
                      WidgetsBinding.instance!.addPostFrameCallback(
                          (_) => createSnackBar("Update succesfully", context));
